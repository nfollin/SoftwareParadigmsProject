...
public class ImageTools {
    ...
    public static byte[] encodingToArray(String encoding){
    	return Base64.decodeBase64(encoding);
    }
    public static String arrayToEncoding(byte [] image){
